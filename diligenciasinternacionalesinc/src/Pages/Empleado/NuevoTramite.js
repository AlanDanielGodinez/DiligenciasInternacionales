...
const CrearTramiteModal = ({ mostrar, cerrar, onTramiteCreado, clientesSeleccionados }) => {
  ...
  const requisitosPorTramite = {
    'Pasaporte Mexicano': `CURP certificada\nActa de nacimiento actualizada\nCredencial de elector\nComprobante de domicilio`,
    'Pasaporte Guatemalteco': `Pasaporte vencido/vigente\nCURP certificada\nActa de nacimiento\nINE\nComprobante de domicilio\nCOMPARENCIA DE AMBOS PADRES (IDENTIFICACIÓN OFICIAL DE AMBOS), si es que es menor de edad`,
    'Pasaporte EstadoUnidense': `Pasaporte vencido/vigente\nCertificado de nacimiento americano\nINE\nComprobante de domicilio actual\nNumero de seguroSocial\n Si tienen doble nacionalidad entregar INE o DPI `,
